...
RSpec.describe "Usage" do
  ...
  describe "get" do
    it "should retrieve account usage" do
      # Top-level keys are symbolized by Resend::Request#process_response;
      # nested hashes keep the string keys from the raw JSON response.
      resp = {
        object: "usage",
        emails: {
          "daily" => { "used" => 258, "limit" => nil, "sent" => 57, "received" => 201, "resets_at" => "2026-07-17T00:00:00.000Z" },
          "monthly" => { "used" => 5442, "limit" => 10_000, "sent" => 1000, "received" => 4442, "resets_at" => "2026-08-01T00:00:00.000Z" }
        },
